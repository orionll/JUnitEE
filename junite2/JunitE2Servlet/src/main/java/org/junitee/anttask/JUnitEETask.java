/*
 * $Id: JUnitEETask.java,v 1.1.1.1 2007-07-13 23:45:13 martinfr62 Exp $
 *
...
public class JUnitEETask extends Task {
  ...
  public void setFiltertrace(boolean filtertrace) {
    Enumeration enum1 = tests.elements();

    while (enum1.hasMoreElements()) {
      ((JUnitEETest) enum1.nextElement()).setFiltertrace(filtertrace);
    }
  }
  ...
  public void setHaltonfailure(boolean value) {
    ...
    while (enum1.hasMoreElements()) {
      ((JUnitEETest) enum1.nextElement()).setHaltonfailure(value);
    }
  }
  ...
  public void setHaltonerror(boolean value) {
    ...
    while (enum1.hasMoreElements()) {
      ((JUnitEETest) enum1.nextElement()).setHaltonerror(value);
    }
  }
  ...
  public void setErrorproperty(String value) {
    ...
    while (enum1.hasMoreElements()) {
      ((JUnitEETest) enum1.nextElement()).setErrorproperty(value);
    }
  }
  ...
  public void setFailureproperty(String value) {
    ...
    while (enum1.hasMoreElements()) {
      ((JUnitEETest) enum1.nextElement()).setFailureproperty(value);
    }
  }
  ...
  public void execute() throws BuildException {
    ...
    while (enum1.hasMoreElements()) {
      JUnitEETest test = (JUnitEETest) enum1.nextElement();
