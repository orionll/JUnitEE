/**
 * $Id: JUnitEEServlet.java,v 1.1.1.1 2007-07-13 23:45:17 martinfr62 Exp $
 * $Source: C:\Users\Orionll\Desktop\junitee-cvs/junite2/JunitE2Servlet/src/main/java/org/junitee/servlet/JUnitEEServlet.java,v $
 */
  ...
  protected String[] getTestClassMethods(String testClass) {
	  ...
	  Class clazz = null;
		...
		if (clazz != null) {
			...
			Runner run = req.getRunner();
			
			Description desc = run.getDescription();
			
			if (desc.testCount() > 0 ) {
			
				ArrayList <Description>descarray = desc.getChildren();
				for (Description d : descarray ){
